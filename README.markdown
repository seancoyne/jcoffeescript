...
JCoffeeScript is a java library that compiles CoffeeScript 1.1.2.

### Usage
from the command prompt:
>    echo "a = 1" | java -jar jcoffeescript-1.1.2.jar
<pre>
      (function() {
          var a;
          a = 1;
...
>    java -jar jcoffeescript-1.1.2.jar < foo.coffee > foo.js
